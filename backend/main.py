...
# from tools.mermaid_tools import generate_mermaid_diagram # Removed since ADK handles this now

from fastapi.middleware.cors import CORSMiddleware

load_dotenv()

# Ensure GOOGLE_API_KEY is pickable by ADK and other agents if only GEMINI_API_KEY is present
...
async def interact(request: InteractionRequest):
    ...
    response["mermaid_diagram"] = adk_result.get("mermaid_diagram")  # Populated by DiagramAgent tool call
